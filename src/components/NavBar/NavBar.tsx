...
const NavBar = () => {
  ...
  return (
    <nav className="navbar bg-gray-200 px-6 py-3 w-full shadow-md flex items-center">
      <Link to="/">
      ...
      <div className="ml-auto flex space-x-3">
        {loggedIn ? (
          <div>
            <Link to="/">
              <button className="btn btn-sm btn-soft bg-red-200 text-red-800">Sign Out</button>
            </Link>
          </div>
        ) : (
          <div className="ml-auto flex space-x-3">
